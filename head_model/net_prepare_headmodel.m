function [headmodel, sens, cfg] = net_prepare_headmodel(cfg, data)
...
if (~isfield(cfg, 'grid') || ~isfield(cfg.grid, 'leadfield'))   % added by DM 30/03/2017
