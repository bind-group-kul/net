function net_normalize_sMRI(job)


structural_file=job.t1w;
results_directory=job.res_dir;
template=job.t1_template;
tpm=job.tpm_file;
biasreg=job.biasreg_t1;
biasfwhm=job.biasfwhm_t1;
bb=job.bb;
structural_res=job.s_vox;
delete_flag=job.DelIntermediate;

if not(isdir(results_directory))
    mkdir(results_directory);
end
output_directory=[results_directory filesep 'tmp'];
...
pos=strfind(structural_file,',');
if ~isempty(pos)
structural_file=structural_file(1:pos-1);
end

pos=strfind(template,',');
if ~isempty(pos)
template=template(1:pos-1);
end
...
[dd,f_struct,ext]=fileparts(structural_file);
if strcmp(ext,'.gz')
    gunzip(structural_file,output_directory);
    movefile([output_directory filesep f_struct],[output_directory filesep 'structural3D.nii'],'f');
else
    copyfile(structural_file,[output_directory filesep 'structural3D.nii'],'f');
end
...
[bb_i,vox_i]=net_world_bb([output_directory filesep 'structural3D.nii,1']);


if not(biasfwhm==Inf)

    
disp('performing bias correction...');


clear matlabbatch

matlabbatch{1}.spm.spatial.preproc.channel.vols = {[output_directory filesep 'structural3D.nii,1']};
...
spm_jobman('run',matlabbatch);
    ...
    copyfile([output_directory filesep 'structural3D.nii'],[output_directory filesep 'mstructural3D.nii']);
...
matlabbatch{1}.spm.tools.oldnorm.estwrite.eoptions.reg = 0.001; %.0.01;
matlabbatch{1}.spm.tools.oldnorm.estwrite.roptions.preserve = 0;
matlabbatch{1}.spm.tools.oldnorm.estwrite.roptions.bb = bb_t;
matlabbatch{1}.spm.tools.oldnorm.estwrite.roptions.vox = vox_t;
matlabbatch{1}.spm.tools.oldnorm.estwrite.roptions.interp = 4;
...
disp('applying deformations...');


clear matlabbatch

matlabbatch{1}.spm.util.defs.comp{1}.def = {[output_directory filesep  'y_to_mni.nii']};
matlabbatch{1}.spm.util.defs.out{1}.push.fnames = {
                                                   [output_directory filesep  'mstructural3D.nii,1']
                                                    };
matlabbatch{1}.spm.util.defs.out{1}.push.weight = {''};
matlabbatch{1}.spm.util.defs.out{1}.push.savedir.savesrc = 1;
matlabbatch{1}.spm.util.defs.out{1}.push.fov.bbvox.bb = bb_t;
matlabbatch{1}.spm.util.defs.out{1}.push.fov.bbvox.vox = vox_t;
matlabbatch{1}.spm.util.defs.out{1}.push.preserve = 0;
matlabbatch{1}.spm.util.defs.out{1}.push.fwhm = [2 2 2];
...
matlabbatch{1}.spm.spatial.coreg.write.ref = {[output_directory filesep 'wmstructural3D.nii,1']};
matlabbatch{1}.spm.spatial.coreg.write.source = {[output_directory filesep 'mni_mask_out.nii,1']};
...
disp('deriving segmented tissues in original and template spaces...');


clear matlabbatch

matlabbatch{1}.spm.spatial.preproc.channel.vols = {[output_directory filesep 'wwwmstructural3D.nii']};
matlabbatch{1}.spm.spatial.preproc.channel.biasreg = 0.001;
matlabbatch{1}.spm.spatial.preproc.channel.biasfwhm = Inf;
matlabbatch{1}.spm.spatial.preproc.channel.write = [0 0];
matlabbatch{1}.spm.spatial.preproc.tissue(1).tpm = {[tpm ',1']};
...
matlabbatch{1}.spm.util.defs.comp{1}.def = {[output_directory filesep  'y_to_subj.nii']};
matlabbatch{1}.spm.util.defs.out{1}.push.fnames = {
                                                   [output_directory filesep  'c1wwwmstructural3D.nii']
                                                   [output_directory filesep  'c2wwwmstructural3D.nii']
                                                   [output_directory filesep  'c3wwwmstructural3D.nii']
                                                   [output_directory filesep  'c4wwwmstructural3D.nii']
                                                   [output_directory filesep  'c5wwwmstructural3D.nii']
                                                   [output_directory filesep  'c6wwwmstructural3D.nii']
                                                    };
matlabbatch{1}.spm.util.defs.out{1}.push.weight = {''};
matlabbatch{1}.spm.util.defs.out{1}.push.savedir.savesrc = 1;
matlabbatch{1}.spm.util.defs.out{1}.push.fov.file = {[output_directory filesep  'mstructural3D.nii']};
matlabbatch{1}.spm.util.defs.out{1}.push.preserve = 0;
matlabbatch{1}.spm.util.defs.out{1}.push.fwhm = [0 0 0];
...
matlabbatch{1}.spm.util.defs.comp{1}.def = {[output_directory filesep  'y_to_mni.nii']};
matlabbatch{1}.spm.util.defs.out{1}.push.fnames = {
                                                   [output_directory filesep  'wc1wwwmstructural3D.nii']
                                                   [output_directory filesep  'wc2wwwmstructural3D.nii']
                                                   [output_directory filesep  'wc3wwwmstructural3D.nii']
                                                   [output_directory filesep  'wc4wwwmstructural3D.nii']
                                                   [output_directory filesep  'wc5wwwmstructural3D.nii']
                                                   [output_directory filesep  'wc6wwwmstructural3D.nii']
                                                    };
matlabbatch{1}.spm.util.defs.out{1}.push.weight = {''};
matlabbatch{1}.spm.util.defs.out{1}.push.savedir.savesrc = 1;
matlabbatch{1}.spm.util.defs.out{1}.push.fov.bbvox.bb = bb;
matlabbatch{1}.spm.util.defs.out{1}.push.fov.bbvox.vox = [structural_res structural_res structural_res];
...
copyfile([output_directory filesep 'mstructural3D.nii'],[results_directory filesep 'mstructural3D.nii']);
copyfile([output_directory filesep 'wwwmstructural3D.nii'],[results_directory filesep 'wmstructural3D.nii']);
copyfile([output_directory filesep 'y_to_mni.nii'],[results_directory filesep 'y_to_mni.nii']);
copyfile([output_directory filesep 'y_to_subj.nii'],[results_directory filesep 'y_to_subj.nii']);
copyfile([output_directory filesep 'wc1wwwmstructural3D.nii'],[results_directory filesep 'c1structural3D.nii']);
copyfile([output_directory filesep 'wc2wwwmstructural3D.nii'],[results_directory filesep 'c2structural3D.nii']);
copyfile([output_directory filesep 'wc3wwwmstructural3D.nii'],[results_directory filesep 'c3structural3D.nii']);
copyfile([output_directory filesep 'wc4wwwmstructural3D.nii'],[results_directory filesep 'c4structural3D.nii']);
copyfile([output_directory filesep 'wc5wwwmstructural3D.nii'],[results_directory filesep 'c5structural3D.nii']);
copyfile([output_directory filesep 'smwwc1wwwmstructural3D.nii'],[results_directory filesep 'mwc1structural3D.nii']);
copyfile([output_directory filesep 'smwwc2wwwmstructural3D.nii'],[results_directory filesep 'mwc2structural3D.nii']);
copyfile([output_directory filesep 'smwwc3wwwmstructural3D.nii'],[results_directory filesep 'mwc3structural3D.nii']);
copyfile([output_directory filesep 'smwwc4wwwmstructural3D.nii'],[results_directory filesep 'mwc4structural3D.nii']);
copyfile([output_directory filesep 'smwwc5wwwmstructural3D.nii'],[results_directory filesep 'mwc5structural3D.nii']);
