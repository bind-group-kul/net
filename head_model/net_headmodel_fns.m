...
try
   ...
   fns_region_write(elecfile,electrodes);
    ...
    if ~ispc
        ...
        fprintf(efid,[pp filesep 'elecsfwd -img ' tmpfolder filesep segfile ' -electrodes ' tmpfolder filesep elecfile ' -data ', ...
            tmpfolder filesep datafile ' -contable ' tmpfolder filesep confile ' -TOL ' num2str(tolerance) ' \n']);% changed by QL, 15.06.2017
    end
    fclose(efid);
