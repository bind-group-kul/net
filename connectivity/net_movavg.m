function [data_avg,t_avg] = net_movavg(data,t,winsize,overlap,use_hanning)
% Moving window averaging
% [data_avg,t_avg] = net_movavg(data,t,winsize,overlap)
% -----------------------------------------------------------------
...
bf       = net_buffer(data,winsize,round(winsize*overlap),'nodelay');
tbf      = net_buffer(t,winsize,round(winsize*overlap),'nodelay');
