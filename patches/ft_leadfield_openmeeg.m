...
% OPENMEEG_PATH = '/Users/quanyingliu/openmeeg/build/src'; 


OPENMEEG_PATH = zet_getpath('external/OpenMEEG/bin');
...
% pathsensor = fileparts(sensorFile);
% mkdir( pathsensor );
...
% [stat res] = system([fullfile('/Users/quanyingliu/openmeeg/build/tools', 'om_check_geom'), ' -g ', geomFile]);  
% 
% if stat > 0
%     error([res, '...quitting']);
% end
