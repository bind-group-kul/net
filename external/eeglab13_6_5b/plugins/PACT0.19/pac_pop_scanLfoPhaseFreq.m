...
phaseFreqRange = str2double(userInput{1,1});
numPhaseFreqs  = str2double(userInput{1,2});
ampFreqRange   = str2double(userInput{1,3});
hasRateRange   = str2double(userInput{1,4});
numHasRates    = str2double(userInput{1,5});
