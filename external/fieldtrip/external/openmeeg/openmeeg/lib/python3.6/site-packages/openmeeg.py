...
Vect3.__idiv__ = new_instancemethod(_openmeeg.Vect3___idiv__, None, Vect3)
...
Vect3.__div__ = new_instancemethod(_openmeeg.Vect3___div__, None, Vect3)
...
Vector.__idiv__ = new_instancemethod(_openmeeg.Vector___idiv__, None, Vector)
...
Vector.__div__ = new_instancemethod(_openmeeg.Vector___div__, None, Vector)
...
Matrix.__div__ = new_instancemethod(_openmeeg.Matrix___div__, None, Matrix)
...
Matrix.__idiv__ = new_instancemethod(_openmeeg.Matrix___idiv__, None, Matrix)
...
SymMatrix.__div__ = new_instancemethod(_openmeeg.SymMatrix___div__, None, SymMatrix)
...
SymMatrix.__idiv__ = new_instancemethod(_openmeeg.SymMatrix___idiv__, None, SymMatrix)
...
def asarray(*args):
    return _openmeeg.asarray(*args)
asarray = _openmeeg.asarray

def fromarray(_mat):
    return _openmeeg.fromarray(_mat)
fromarray = _openmeeg.fromarray
