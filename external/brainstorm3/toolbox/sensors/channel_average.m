...
for i = 2:length(ChannelMats)
    ...
    for iChan = 1:length(MeanChannelMat.Channel)
        ...
        if ~isequal(size(MeanChannelMat.Channel(iChan).Loc), size(ChannelMats{i}.Channel(iChan).Loc))
...
for iChan = 1:length(MeanChannelMat.Channel)
    MeanChannelMat.Channel(iChan).Loc    = MeanChannelMat.Channel(iChan).Loc / length(ChannelMats);
    MeanChannelMat.Channel(iChan).Orient = MeanChannelMat.Channel(iChan).Orient / length(ChannelMats);
end
