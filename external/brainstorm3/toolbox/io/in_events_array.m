function events = in_events_array(sFile, EventFile, format)
% IN_EVENTS_ARRAY: Read events information from a .mat or text file 
%
% USAGE:  events = in_events_array(sFile, EventFile, 'times')
%         events = in_events_array(sFile, EventFile, 'samples')  
