...
% READ_SVREG: Import an atlas from an SVReg-labelled surface
%
% USAGE: read_svreg(FileName, Verbosity=1) : Load labeled vertices from given file
%
% INPUT
...
% Authors: Andrew Krause, 2013
    ...
    if isempty(XmlFile)
        fprintf(1, 'Could not find XML label description file brainsuite_labeldescription.xml');
        return;
    end
