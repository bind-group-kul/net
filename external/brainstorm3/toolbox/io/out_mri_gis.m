...
OutputVolume = int16(BstMat.Cube);
...
header = sprintf(['%d %d %d 1\n' ...
                  ...
                  BstMat.Voxsize(1), BstMat.Voxsize(2), BstMat.Voxsize(3));
% Save header
