...
function OutputFiles = Run(sProcess, sInputs) %#ok<DEFNU>
    ...
    if isDirectImport
        ...
        for iFile = 1:length(FileNames)
            ...
            sFile = FileMat.F;
            OutputFiles = import_data(sFile, sFile.format, iStudy, iSubject, ImportOptions);
        end
    end
    ...
    if ~isempty(OutputFiles)
        ...
        bst_report('Error', sProcess, sInputs, 'No good time segments imported from those files.');
    end
end
