...
%        [DefFunction, ColormapType] = process_tf_measure('GetDefaultFunction', Method)
...
%% ===== GET DEFAULT MEASURE =====
% USAGE:   [DefFunction, ColormapType] = process_tf_measure('GetDefaultFunction', Method)
function [DefFunction, ColormapType] = GetDefaultFunction(Method) %#ok<DEFNU>
    switch lower(Method)
