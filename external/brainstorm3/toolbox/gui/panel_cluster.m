...
function bstPanelNew = CreatePanel() %#ok<DEFNU>
    ...
    jMenuBar = gui_component('MenuBar', jPanelNew, BorderLayout.NORTH);
        ...
        gui_component('ToolbarButton', jToolbar,[],[], IconLoader.ICON_NEW_IND, '<HTML><B>Create new cluster: list of indices.</B><BR>Type the list of sensors indices you want in the new cluster.', @(h,ev)CreateNewCluster('Indices'));
        ...
        jMenu.setBorder(BorderFactory.createEmptyBorder(0,2,0,2));
            ...
            gui_component('MenuItem', jMenu, [], 'New cluster: List of indices',      IconLoader.ICON_NEW_IND, [], @(h,ev)CreateNewCluster('Indices'), []);
